  ...
  /* ===== CONTACT FORM ===== */
	...
	/* ===== GOOGLE MAPS  ===== */
		...
		/* ~~~ Default Map ~~~ */
		if($("#myMap").length>0){
			var $latitude = -1.159, // Latitude for Gathanji, Githunguri, Kiambu County, Kenya
				$longitude = 37.191, // Longitude for Gathanji, Githunguri, Kiambu County, Kenya
				$map_zoom = 12,
				...
				contentString = '<div id="mapcontent"><p>Gathanji, Githunguri, Kiambu County, Kenya</p></div>',
